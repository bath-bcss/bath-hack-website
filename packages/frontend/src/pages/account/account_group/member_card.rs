...
pub fn member_card(member: GroupMember) -> Html {
    html! {
    <div key={member.bath_username.clone()} class="bg-bcss-100 dark:bg-bcss-800 px-4 py-2 rounded-xl w-full sm:w-auto">
        <p class="text-xs mb-1 text-bcss-700 dark:text-bcss-300">
            {"Member"}
        </p>
